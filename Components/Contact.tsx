...
const Contact = () => {
	...
	return (
		<div className="pt-[8rem] pb-[4rem] bg-[#efefef]" id="Contact">
			<div className="grid pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[90%] mx-auto gap-[3rem]">
				...
				<div className="flex items-center space-x-6">
					...
					<div>
						...
						<p className="text-[17px] w-[90%] text-white opacity-60 whitespace-nowrap">
							1-705-808-1229
						</p>
					</div>
				</div>
			...
			<div className="w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between">
				...
				<div className="flex items-center space-x-10">
					<div
						onClick={() => openNewTab("htts://www.github.com/Mike-The-Fyke")}
					>
						<Image
