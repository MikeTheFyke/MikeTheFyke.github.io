...
const Experience = () => {
	...
	return (
		...
		>
			...
			<div className="w-[80%] pt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 gap-[1rem]">
				{experience.map((item) => {
					return (
						<div
							className="shadow rounded-md p-4 mx-auto cursor-pointer mt-[2rem] max-h-[500px] whitespace-nowrap sm:min-w-[400px]"
