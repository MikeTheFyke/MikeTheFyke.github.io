...
const Hero = () => {
	...
	return (
		<div className="h-[88vh] bg-[#EFEFEF] mt-[12vh]" id="Hero">
			{/* <Particle /> */}
			<div className="w-[80%] grid-cols-1 mx-auto grid md:grid-cols-2 lg:grid-cols-2 sm:gap-[1rem] md:gap-[4rem] lg:gap-[3rem] h-[90%] md:h-[100%] lg:h-[100%] items-center">
				...
				<div className="hidden md:flex md:justify-center md:items-center md:w-[100%] lg:hidden">
					<div
						data-aos="zoom-in"
